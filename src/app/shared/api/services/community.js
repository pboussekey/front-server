...
angular.module('API')
    .factory('community_service',['api_service','$q','page_model','user_model',
        function( api_service, $q, page_model, user_model ){
            ...
            var service = {
                users: function( search, p, n, exclude, page_id, role, random, page_type, order, contact_state, is_pinned, is_active, tags ){
                ...
                tags: function(search, category, p, n, exclude, page_id){
                    return api_service.send('tag.getList',{search : search, category : category,
                      exclude : exclude, page_id : page_id, filter:{p:p,n:n,o:{"tag$weight":"DESC"}}});
                },
