angular.module('API').factory('page_users',
    ['api_service','session','pum_model','pui_model','pua_model', 'puadmin_model', 'puunsent_model', '$q','service_garbage',
        function( api, session, pum_model, pui_model, pua_model, puadmin_model, puunsent_model, $q, service_garbage ){
