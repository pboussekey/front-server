...
angular.module('API')
    .factory('notifications',['abstract_paginator_model','$q','api_service','service_garbage','storage',
        function( abstract_paginator_model, $q, api_service, service_garbage, storage ){
            ...
            var events = {
                  displayed_types : ["user.follow", "post.create","post.com","post.share", "page.member", "page.invited", "page.pending", "post.like", "post.tag", "page.doc", "section.publish","item.publish", "item.update"],
