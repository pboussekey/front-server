...
angular.module('API')
    .factory('uom_model',['abstract_model_service','pages_constants',
        function(abstract_model_service, pages_constants){        
            ...
            var service = new abstract_model_service({
                ...
                _buildGetParams: function( ids ){
                    return { user_id: ids, type: pages_constants.pageTypes.ORGANIZATION, state : pages_constants.pageStates.MEMBER };
                }
            });
